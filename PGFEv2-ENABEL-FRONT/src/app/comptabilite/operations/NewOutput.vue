...
// Validation schema based on backend contract (OutputAccount)
...
const onSubmit = handleSubmit(async (values) => {
  try {
    await postData(API_ROUTES.CREATE_OUTPUTACCOUNT, values)
    ...
    <form @submit.prevent="onSubmit" class="mt-10 space-y-8">
      ...
      <div class="flex items-center justify-end gap-2">
        ...
        <Button type="submit" :disabled="loading">
          ...
          <span v-if="!loading">Enregistrer la sortie</span>
