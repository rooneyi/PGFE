...
final class AcademicPersonalRequest extends FormRequest
{
    use SchoolIdRule;
    ...
    public function rules(): array
    {
        return [
            ...
            'matricule' => ['required', 'string', 'max:255', new Unique(AcademicPersonal::class, 'matricule')],
            ...
            'phone' => [
                ...
                'string',
                'max:20',
                new Unique(AcademicPersonal::class, 'phone'),
                (new Phone())->country('CD'),
            ],
            'email' => ['required', 'email', new Unique(AcademicPersonal::class, 'email')],
            'identity_card_number' => ['required', 'string', 'max:255', new Unique(AcademicPersonal::class, 'identity_card_number')],
    ...
    /**
     * Messages de validation personnalisés (français).
     *
