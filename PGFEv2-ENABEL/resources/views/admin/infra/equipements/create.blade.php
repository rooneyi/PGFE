...
@section('admin-content')
    <div class="space-y-6">
        <nav class="flex items-center gap-2 text-xs font-semibold text-gray-500 uppercase tracking-widest">
            <!-- BREADCRUMBS: [['title' => 'Équipements', 'url' => route('admin.infra-equipements.index')], ['title' => 'Ajout']] -->
        </nav>
    </div>
    ...
    <div class="max-w-4xl mx-auto space-y-10">
        ...
        <div class="flex items-center justify-between bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-800">
            <div class="flex items-center gap-6">
                ...
                <div>
                    <h1 class="text-3xl font-black text-gray-800 dark:text-white">Nouvel Équipement</h1>
                    <p class="text-sm text-gray-500 font-medium mt-1">Enregistrement d'un nouveau matériel ou mobilier.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
            <form action="{{ route('admin.infra-equipements.store') }}" method="POST" class="p-10 space-y-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="name" required placeholder="ex: Bureau d'écolier bi-place" 
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="code" placeholder="ex: EQ-2024-001" 
                                class="w-full h-14 px-5 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-950 focus:ring-blue-500 font-bold transition-all" />
                        </div>

                        <div class="space-y-2">
                            <label class="text-sm font-black text-gray-700 dark:text-gray-300 ml-1">Emplacement précis</label>
                            <input type="text" name="emplacement" placeholder="ex: Salle de classe 4B" 
                                class="w-full h-14 px-5 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-950 focus:ring-blue-500 font-bold transition-all" />
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" name="montant_acquisition" step="0.01" 
                                    class="w-full h-14 px-5 rounded-2xl border-gray-100 dark:border-gray-800 dark:bg-gray-950 focus:ring-blue-500 font-bold transition-all" />
                            </div>
                        </div>
                    </div>
