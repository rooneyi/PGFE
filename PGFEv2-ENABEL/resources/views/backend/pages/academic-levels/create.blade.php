    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-800">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-black text-gray-800 dark:text-white">Nouveau niveau académique</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 font-medium tracking-tight">Définir un palier d'enseignement rattaché à un cycle.</p>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
            <form method="POST" action="{{ route('admin.academic-levels.store') }}" class="p-10 space-y-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="name" name="name" type="text" value="{{ old('name') }}" required placeholder="Ex: 7e année"
