...
@section('admin-content')
    ...
    <x-breadcrumb :links="[['label' => 'Dashboard', 'url' => route('admin.dashboard')], ['label' => 'Utilisateurs', 'url' => route('admin.users.index')]]" current="Créer un Utilisateur" />
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="flex items-center justify-between bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] shadow-xl border border-gray-100 dark:border-gray-800">
            <div class="flex items-center gap-4">
                <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center text-white shadow-lg shadow-violet-600/20">
                    <iconify-icon icon="lucide:user-plus" width="32"></iconify-icon>
                </div>
                <div>
                    <h1 class="text-2xl font-black text-gray-800 dark:text-white">Nouveau Compte</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 font-medium tracking-tight">Créez un nouvel accès utilisateur au système.</p>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-10 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" required placeholder="jean.dupont@exemple.com"
                                   class="w-full h-14 pl-12 rounded-2xl bg-gray-50 dark:bg-gray-800 border-none font-bold text-gray-800 dark:text-white focus:ring-2 focus:ring-violet-600 transition-all">
                        </div>
                    ...
                    <!-- School Selection -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-gray-400 uppercase tracking-widest px-1">École d'affectation (Optionnel)</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400">
                ...
                <div class="pt-6 border-t border-gray-50 dark:border-gray-800 flex justify-end">
                    <button type="submit" class="inline-flex items-center justify-center gap-3 rounded-2xl bg-violet-600 px-12 py-5 text-sm font-black text-white hover:bg-violet-700 shadow-xl shadow-violet-600/20 transition-all hover:-translate-y-1">
