...
>
    ...
    <dd class="ml-16 flex items-baseline pb-6 sm:pb-7">
        ...
        <div class="absolute inset-x-0 bottom-0 bg-gray-50 dark:bg-gray-700 px-4 py-4 sm:px-6">
            <div class="text-sm">
                <a href="{{ $url ?? '#' }}" class="font-medium flex items-center text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">{{ __('dashboard.view_all') }}
