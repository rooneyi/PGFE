...
@section('admin-content')
    <x-admin.shadcn-shell
        ...
        subtitle="Ajouter une filiere ou section."
        icon="lucide:git-branch"
        breadcrumbCurrent="Creer une filiere"
    >
        <x-slot:actions>
        ...
        <div class="overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm">
            <form method="POST" action="{{ route('admin.filiaires.store') }}" class="space-y-6 p-6 md:p-8">
                @csrf
